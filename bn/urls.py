...
from accounts.forms import LoginForm_bn, SignupForm_bn
...
def chapter1 (request):
    ...
    if 'Chapter 1' in sales:
        return render(request,'bn/chapter1.html')
    else:
...
def chapter2 (request):
    ...
    if 'Chapter 2' in sales:
        return render(request,'bn/chapter2.html')
    else:
        return redirect('/bn/membership')
...
def chapter3 (request):
    ...
    if 'Chapter 3' in sales:
        return render(request,'bn/chapter3.html')
    else:
        return redirect('/bn/membership')
...
def chapter4 (request):
    ...
    if 'Chapter 4' in sales:
        return render(request,'bn/chapter4.html')
    else:
        return redirect('/bn/membership')  
...
def chapter5 (request):
    ...
    if 'Chapter 5' in sales:
        return render(request,'bn/chapter5.html')
    else:
        return redirect('/bn/membership')  
...
def chapter6 (request):
    ...
    if 'Chapter 6' in sales:
        return render(request,'bn/chapter6.html')
    else:
        return redirect('/bn/membership')        
...
def chapter7 (request):
    ...
    if 'Chapter 7' in sales:
        return render(request,'bn/chapter7.html')
    else:
        return redirect('/bn/membership')
...
def thecircleoflove (request):
    ...
    if 'The Circle of Love' in sales:
        return render(request,'bn/thecircleoflove.html')
    else:
        return redirect('/bn/membership')
...
def signup_view(request):
    if request.method == 'POST':
        form = SignupForm_bn(request.POST)
        if form.is_valid():
            user = form.save()
    #        login(request, user)
            return redirect('bn-login')
    else:
        form = SignupForm_bn()
...
def signin_view(request):
    if request.method == 'POST':
        form = LoginForm_bn(request.POST)
        if form.is_valid():
...
urlpatterns=[
    ...
    path('chapter1/', chapter1, name='bn-chapter1'),
    path('chapter2/', chapter2, name='bn-chapter2'),
    path('chapter3/', chapter3, name='bn-chapter3'),
    path('chapter4/', chapter4, name='bn-chapter4'),
    path('chapter5/', chapter5, name='bn-chapter5'),
    path('chapter6/', chapter6, name='bn-chapter6'),
    path('chapter7/', chapter7, name='bn-chapter7'),
    path('thecircleoflove/', thecircleoflove, name='bn-thecircleoflove'),
